...
class ProgressMapTool(QgsMapTool):
    ...
    def analyzeTrack(self, sector):
        ...
        if currentLayer.crs().authid() != "EPSG:4326" or currentLayer.wkbType() != QGis.WKBLineString:
            QMessageBox.information(None, "CHYBA:", u"Vybraná vrstva není stopou. Vyberte správnou vrstvu.")
            return
